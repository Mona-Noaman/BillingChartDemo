...
class LoginService {
    ...
    func initOpenIdConfiguration(with url: String, closure: @escaping LoginServiceClosure) {
        ...
        _ = networkService.networkRequest(request: configurationRequest,
                                          parser: configurationParser,
                                          withCompletion: { data, error in
    ...
    func login(tokenEndpoint: String,
        ...
        _ = networkService.networkRequest(request: tokensRequest,
                                          parser: tokenReponseParser,
                                          withCompletion: { data, error in
