...
struct BasicAnimationKeys {
    static let pathKey: String = "path"
}

struct SplashToGenericAnimationConstants {
...
struct CircleMaskAnimationConstants {
...
struct PostSplashToGenericAnimationConstants {
...
struct SplashToDashboardAnimationConstants {
...
struct BackgroundFadeAnimationConstants {
    static let startTime: Double = 0.12
    static let duration: Double = 0.83
}

struct PostSplashToDashboardAnimationConstants {
