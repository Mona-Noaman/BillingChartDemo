...
class VFGSplashToGenericTransitionAnimation: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func postSplashContentScaleUpAnimation(toView: UIView) {
        UIView.animateKeyframes(withDuration: PostSplashToGenericAnimationConstants.duration,
                                delay: PostSplashToGenericAnimationConstants.delay,
                                options: [.calculationModePaced], animations: {
            UIView.addKeyframe(withRelativeStartTime: 0,
                               relativeDuration: 1,
                               animations: {
                toView.transform = CGAffineTransform(scaleX: PostSplashToGenericAnimationConstants.scaleEndRatio,
    ...
    func startMaskAnimation(fromVC: VFGAnimatedSplashViewController, toVC: UIViewController) {
        ...
        toView.transform = CGAffineTransform(scaleX: PostSplashToGenericAnimationConstants.scaleBeginRatio,
